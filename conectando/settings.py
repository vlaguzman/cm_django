...
ADMINS = (
    ('Vladimir Guzman', 'guzman.vla@gmail.com'),
)
...
if bool(os.environ.get('LOCAL_DEV', DEBUG)):  
  DATABASES = {
    'default': {
        ...
        'NAME': 'conectando_db',                      # Or path to database file if using sqlite3.
...
# Example: "/home/media/media.lawrence.com/static/" exp. STATIC_ROOT = 'os.path.join(RUTA_PROYECTO,'static')'
...
SECRET_KEY = 'm8$kd-@0ev#_=v=w8(gywq_#1rub4gb^j)!&amp;)3!3*=osv3b^v*'
